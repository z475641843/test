...
#define K                       29
#define SERVO_KP                1.15    //舵机P值  1.25   1.2  1.15
#define SERVO_KD                14      //舵机D值  0.0    8    14
...
//  printf("left_in=%d\n", left_in);
//  printf("left_white_num=%d\n", left_white_num);
//  printf("left_curve=%d\n", left_curve);
//  printf("right_in=%d\n", right_in);
//  printf("right_white_num=%d\n", right_white_num);
//  printf("right_curve=%d\n\n", right_curve);
...
//  }
//
//  else if(left_in == 0 && right_in == 1 && right_white_num >= 25 && right_curve == 0 )
//  {
//    flag = RIGHT_ISLAND_IN_FLAG;
//    right_island_in_flag = 1;
//    island_in_count += 1;
//  }
//  else if(left_in == 1 && right_in == 0 && left_white_num >= 25 && left_curve == 0 )
//  {
